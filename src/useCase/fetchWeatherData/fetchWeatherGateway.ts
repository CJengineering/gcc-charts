...
export  class ApiWeatherGateway implements WeatherGateway  {
    async fetchWeatherData(year:number): Promise<WeatherData[]> {
 
      const response = await fetch(`https://gcc-api-e4f6j5kdsq-ew.a.run.app/weather_data/by_year?year=${year}&month=8`);
